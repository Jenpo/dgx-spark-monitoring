...
**完整的可复算论证与真机验证命令：** [`docs/gb10-specific-panels.md`](docs/gb10-specific-panels.md) · **锁频与统一内存实操笔记** [`docs/engineering/gb10-thermal-unified-memory.md`](docs/engineering/gb10-thermal-unified-memory.md)
